            ...
            <div className="mt-8 border-t border-zinc-200/40 pt-6">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <a
                  ...
                  className="group/link inline-flex items-center gap-1.5 rounded-full border border-zinc-300 bg-white text-zinc-950 px-5 py-2.5 text-xs font-bold font-display uppercase tracking-wider hover:bg-zinc-100 transition-all duration-300 shadow-sm hover:shadow-md"
                >
                  Launch Project
                  <Icon name="arrowUpRight" className="h-3.5 w-3.5 transition-transform duration-300 group-hover/link:translate-x-0.5 group-hover/link:-translate-y-0.5" />
                </a>
              </div>
            </div>
          </div>

          {/* Project mockup wrapper with ParallaxImage */}
          <div className="relative overflow-hidden rounded-xl border border-zinc-200/60 bg-zinc-50 p-2 group/img">
            <ParallaxImage
              src={project.image}
              alt={`${project.title} Interface`}
              parallaxSpeed={-8}
              className="rounded-lg h-64 sm:h-72 lg:h-80 w-full"
            />
          </div>
        </div>
      </div>
